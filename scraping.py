...
def scrape_all():
    ...
    browser = Browser("chrome", executable_path="/Users/carmen/.wdm/drivers/chromedriver/mac64/87.0.4280.88/chromedriver", headless=True)
    ...
    data = {
        ...
        "facts": mars_facts(),
        "hemispheres": scraping_mars_hemispheres_image_urls_and_titles(browser),
...
def scraping_mars_hemispheres_image_urls_and_titles(browser):
